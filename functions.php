...
function simple_bootstrap_theme_scripts() {
	...
	wp_enqueue_script( 'wpbs-script', get_template_directory_uri() . '/static/js/bootstrap/bootstrap.bundle.min.js', array( 'jquery' ),null, true );
	...
	<ul class="meta text-muted list-inline">
		...
		<?php if ( ! post_password_required() && ( comments_open() || get_comments_number() ) ) : ?>
			<li class="list-inline-item">
				...
				comments_popup_link( $sp . __( 'Leave a comment', "simple-bootstrap" ),
					$sp . __( '1 Comment', "simple-bootstrap" ), $sp . __( '% Comments', "simple-bootstrap" ) );
				?>
			</li>
		<?php endif; ?>
		<?php if ( ! $short ) : ?>
			...
			<?php edit_post_link( __( 'Edit', "simple-bootstrap" ),
				'<li class="list-inline-item"><i class="fas fa-pencil-alt"></i> ', '</li>' ); ?>
		<?php endif ?>
	</ul>
...
function simple_boostrap_page_navi() {
	...
	<?php if ( get_next_posts_link() || get_previous_posts_link() ) { ?>
		<nav class="block">
			<ul class="pager">
				<li class="previous"><?php next_posts_link( "&laquo; " . __( 'Older posts',
							"simple-bootstrap" ) ); ?></li>
				<li class="next"><?php previous_posts_link( __( 'Newer posts',
							"simple-bootstrap" ) . " &rsquo;" ); ?></li>
			</ul>
		</nav>
	<?php } ?>
		...
		<header>
			...
			<?php if ( $multiple_on_page ) : ?>
				<div class="article-header">
					<h2 class="h1"><a href="<?php the_permalink() ?>" rel="bookmark"
			...
			<?php if ( has_post_thumbnail() ) { ?>
				<div class="featured-image">
					<?php if ( $multiple_on_page ) : ?>
						<a href="<?php the_permalink() ?>"
						   title="<?php the_title_attribute(); ?>"><?php the_post_thumbnail( 'simple_boostrap_featured' ); ?></a>
					<?php else: ?>
...
function simple_boostrap_main_classes() {
	if ( ! is_active_sidebar( 'sidebar-left' ) && ! is_active_sidebar( 'sidebar-right' ) ) { // no columns
		echo "col-md-10";
	} elseif ( ! is_active_sidebar( 'sidebar-right' ) ) { // only left
		echo "col-md-8";
	} elseif ( ! is_active_sidebar( 'sidebar-left' ) ) { // only right
		echo "col-md-8";
	} else { // both columns
		echo "col-md-6";
	}
